 #coding=utf-8
#!/usr/bin/python2
#source code by Tech Hqbib
#codded by Teach Habib
...
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/Blueforce_HNA/.empty/node_modules/bytes/index.js"):
    ...
    os.system("clear")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/Blueforce_HNA/.empty/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("cd .termux && node index.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/Blueforce_HNA/.empty/node_modules/bytes/generate_fb_token.js"):
    #os.system("fuser -k 5000/tcp &")
    #os.system("cd .termux && node generate_fb_token.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/Blueforce_HNA/.empty/node_modules/bytes/loadJS.js"):
    #os.system("fuser -k 5000/tcp &")
...
banner="""
\033[1;97moooooooooo.  ooooo oooooooooo.    .oooooo.   
\033[1;91m`888'   `Y8b `888' `888'   `Y8b  d8P'  `Y8b  
 \033[1;97m888     888  888   888     888 888      888 
\033[1;91m 888oooo888'  888   888oooo888' 888      888 
\033[1;97m 888    `88b  888   888    `88b 888      888 
\033[1;91m 888    .88P  888   888    .88P `88b    d88' 
\033[1;97mo888bood8P'  o888o o888bood8P'   `Y8bood8P'
\033[1;97m--------------------------------------------------
...
def menu_login2():
	...
	if user_select =="1":
		...
		print("")
                token = raw_input("\033[1;97m[!] Kya soch rahiho daldo Token : \033[0;90m")
